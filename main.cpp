...
void process_input()
{
    if (g_current_scene->get_state().player) {
        ...
        if (key_state[SDL_SCANCODE_LEFT]) {
            ...
            g_current_scene->get_state().player->set_animation_state(MOVE_RIGHT);
            if (key_state[SDL_SCANCODE_A]) {
